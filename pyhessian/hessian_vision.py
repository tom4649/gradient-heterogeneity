...
class hessian_vision:
    ...
    def __init__(
        ...
        params, gradsH = get_params_grad(self.model, param_name=param_name)
        self.params = params
    ...
    def eigenvalues(self, maxIter=100, tol=1e-3, top_n=1, get_maximum=False):
        ...
        get_maximum: if True, only return the maximum eigenvalue and its corresponding eigenvector
        """
